...
<body>
    <div class="header">
        <h1>🔬 UterusScope-AI Clinical Report</h1>
        <p>Analysis ID: {{ analysis_id }} | Generated: {{ timestamp }}</p>
    </div>
    
    <div class="disclaimer">
        <strong>⚠️ Medical Disclaimer:</strong> This report is generated by an AI system and is intended as a clinical decision support tool only. 
    ...
    <div class="section candidacy {{ candidacy_class }}">
        <h2>🎯 UG-IHI Candidacy Assessment</h2>
